...
class _SuratKeteranganPenghasilanOrangTuaState extends State<SuratKeteranganPenghasilanOrangTua> {
  ...
  final TextEditingController _tanggalLahirOrtuController =
      TextEditingController();
  final TextEditingController _pekerjaanOrtuController = TextEditingController();
  ...
  final TextEditingController _tempatLahirAnakController = TextEditingController();
  final TextEditingController _tanggalLahirAnakController = TextEditingController();
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              FormWidgets.buildTextField(
                  label: "Tempat Lahir", controller: _tempatLahirOrtuController),
              ...
              FormWidgets.buildTextField(
                  label: "Tempat Lahir", controller: _tempatLahirAnakController),
              FormWidgets.buildDateField(
                  label: "Tanggal Lahir",
