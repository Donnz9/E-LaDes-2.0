...
class SuratIzinKeramaian extends StatefulWidget {
  ...
  @override
  State<SuratIzinKeramaian> createState() => _SuratIzinKeramaianState();
}

class _SuratIzinKeramaianState extends State<SuratIzinKeramaian> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Center(
                child: Text(
                  "Ajukan permohonan Anda untuk mendapatkan Surat Izin Keramaian sebagai dokumen resmi yang menerangkan jumlah penghasilan orang tua, yang dikeluarkan oleh Pemerintah Desa Kauman.",
                  style: TextStyle(
                    fontSize: 14,
              ...
              FormWidgets.buildTextField(
                  label: "Hari", controller: _hariController),
              FormWidgets.buildDateField(
                  label: "Tanggal",
                  controller: _tanggalController,
                  context: context),
              FormWidgets.buildTextField(
                  label: "Waktu", controller: _waktuController),
              FormWidgets.buildTextField(
                  label: "Tempat", controller: _tempatController),
              FormWidgets.buildTextField(
                  label: "Acara", controller: _acaraController),
