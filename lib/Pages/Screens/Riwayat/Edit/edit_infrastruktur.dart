...
class EditInfrastruktur extends StatefulWidget {
  final Map<String, dynamic> data;
  final Function(int)? onNavigate;
  const EditInfrastruktur({
    super.key,
    required this.data,
    this.onNavigate,
  });
  ...
  @override
  State<EditInfrastruktur> createState() => _EditInfrastrukturState();
}

class _EditInfrastrukturState extends State<EditInfrastruktur> {
  ...
  void fillFormFromData(Map<String, dynamic> data) {
    ...
    _jenisInfrastrukturController.text = data['jenis_infrastruktur'] ?? '';
    _deskripsiController.text = data['deskripsi'] ?? '';
    _tanggalController.text = data['tanggal_kejadian'] ?? '';
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  try {
                    // Jika user sudah
                    final response = await EditInfrastrukturService.submitForm(
