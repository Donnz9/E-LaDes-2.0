...
//pengantar
class editSKCKService {
  static Future<Map<String, dynamic>> submitForm({
    required String no_pengajuan,
    ...
    var uri = Uri.parse("${AppConfig.baseUrl}/edit_skck");
    var request = http.MultipartRequest("POST", uri);

    request.fields['no_pengajuan'] = no_pengajuan;
...
class editKehilanganBarangService {
  static Future<Map<String, dynamic>> submitForm({
    required String no_pengajuan,
    required String nama,
    required String tempatLahir,
    ...
    var uri = Uri.parse("${AppConfig.baseUrl}/edit_kehilangan");
    var request = http.MultipartRequest("POST", uri);
...
class editSKTMService {
  static Future<Map<String, dynamic>> submitForm({
    ...
    var uri = Uri.parse("${AppConfig.baseUrl}/edit_sktm");
    var request = http.MultipartRequest("POST", uri);
...
class editPenghasilanService {
  static Future<Map<String, dynamic>> submitForm({
    ...
    var uri = Uri.parse("${AppConfig.baseUrl}/edit_penghasilan");
    var request = http.MultipartRequest("POST", uri);
...
//izin
class editTidakMasukKerjaService {
  static Future<Map<String, dynamic>> submitForm({
    required String no_pengajuan,
    required String nama,
    required String tempatLahir,
    ...
    var uri = Uri.parse("${AppConfig.baseUrl}/edit_kerja");
    var request = http.MultipartRequest("POST", uri);
...
class editKeramaianService {
  static Future<Map<String, dynamic>> submitForm({
    ...
    var uri = Uri.parse("${AppConfig.baseUrl}/edit_keramaian");
    var request = http.MultipartRequest("POST", uri);
